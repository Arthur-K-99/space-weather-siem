...
- Next: M7 — historical-storm replay (`scripts/replay.py`, committed fixtures, timestamps rebased to now so all 6 rules fire) + per-rule runbooks in docs/ + README screenshots
